...
def test_ssrf_blocks_cgnat_100_64():
    ...
    with pytest.raises(ValueError, match="forbidden"):
        with mock.patch("socket.getaddrinfo", return_value=[(None, None, None, None, ("100.64.1.1", 0))]):
...
def test_ssrf_blocks_carrier_grade_198_18():
    ...
    with pytest.raises(ValueError, match="forbidden"):
        with mock.patch("socket.getaddrinfo", return_value=[(None, None, None, None, ("198.18.0.1", 0))]):
...
def test_ssrf_blocks_iana_192_0_0():
    ...
    with pytest.raises(ValueError, match="forbidden"):
        with mock.patch("socket.getaddrinfo", return_value=[(None, None, None, None, ("192.0.0.1", 0))]):
